...
- Source: `StrongNormal.lean`
- Generated: 2025-08-14T00:26:04

```lean
/-
  Strong normalization via a (κ, μ) lexicographic measure.

  This file is intentionally thin: it *only* wires the already-verified μ lemmas
  into a standard lex harness and supplies the κ-drop on `rec_succ`.
  No rec_succ μ-bound is used anywhere.
-/
...
namespace OperatorKernelO6.MetaStrongNormal

-- Bring the μ measure and its lemmas into scope.
open MetaSN
...
end OperatorKernelO6.MetaStrongNormal
